...
//	glb.Assertf(sub!=nil, "faucet configuration not found")
//	var err error
//	if sub != nil {
//		ret.port = sub.GetUint64("port")
//		if server {
//			ret.outputAmount = sub.GetUint64("output_amount")
//			glb.Assertf(ret.outputAmount >= minOutputAmount, "output_amount must be greater than %d", minOutputAmount)
//
...
//	glb.Infof("     controlling address:    %s", cfg.account.String())
